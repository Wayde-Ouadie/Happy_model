...
const rarities = {
    ...
    type RarityName = keyof typeof rarities; 
export const getRarityWithoutBack = (rarity: RARITY, color: COLORS) : StaticImageData => {
  const rarityName: RarityName = `rarity_${rarity}_${color}`;
      return rarities[rarityName].src;
}